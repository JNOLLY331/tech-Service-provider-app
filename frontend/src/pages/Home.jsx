...
import {
  ShieldCheck, Cpu, Globe, ChevronRight,
  Code2, Wifi, ArrowRight, Star, Quote,
  Users, Package, Award, TrendingUp,
  Zap, CheckCircle, Clock, HeartHandshake
} from 'lucide-react';
...
const HERO_SLIDES = [
  ...
  },
  {
    tag: "⚡ Licensed",
    title: "Software\nInstallations.",
    subtitle: "Licensed software deployment & activation for your business. Windows, Office, Antivirus & more.",
    cta: "Get Started",
    ctaPath: "/login",
    accent: "#a78bfa",
  },
  {
    tag: "✨ Portfolio",
    title: "E-Portfolio\nCreation.",
    subtitle: "Beautiful, professional portfolios that open doors. Stand out in the digital world.",
    cta: "Order Now",
    ctaPath: "/login",
    accent: "#10d99a",
  },
...
/* ─── WHY CHOOSE US ─────────────────────────────────────────── */
const WHY_US = [
  { icon: <CheckCircle size={20} />, text: "Licensed software only — no pirated copies" },
  { icon: <CheckCircle size={20} />, text: "Pay via M-Pesa — fast and secure" },
  { icon: <CheckCircle size={20} />, text: "Walk-in or order online from anywhere" },
  { icon: <CheckCircle size={20} />, text: "Free advice and after-service support" },
  { icon: <CheckCircle size={20} />, text: "Experienced technicians with proven track record" },
  { icon: <CheckCircle size={20} />, text: "Affordable pricing for everyone in Eldoret" },
];
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-base max-w-xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
            Everything your business needs, from software to web presence — all under one roof.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {loading ? (
            ...
            <div
              ...
              style={{ background: 'var(--red-bg)', border: '1px solid rgba(255,77,106,0.2)' }}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-10" style={{ color: 'var(--text-secondary)' }}>
              We don't just fix computers — we build tech solutions that help Eldoret's businesses and individuals thrive in the digital age.
            </p>
            <ul className="space-y-4">
              {WHY_US.map((item, i) => (
                <li key={i} className="flex items-center gap-3">
                  <span style={{ color: 'var(--emerald)', flexShrink: 0 }}>{item.icon}</span>
            ...
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <Quote size={20} style={{ color: 'var(--accent-primary)', flexShrink: 0, marginTop: '2px' }} />
                  <div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-0.5">
                        {[...Array(t.rating)].map((_, si) => (
                          <Star key={si} size={13} style={{ color: '#ffb547', fill: '#ffb547' }} />
                        ))}
                      </div>
                    </div>
                  </div>
