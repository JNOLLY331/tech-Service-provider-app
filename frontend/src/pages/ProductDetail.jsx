...
import {
    ShoppingBag, ArrowLeft, CheckCircle2, AlertTriangle,
    Database, Shield, Loader2, Package, Star,
    Share2, Heart, Truck, RotateCcw, BadgeCheck
} from 'lucide-react';
...
export default function ProductDetail() {
    ...
    const stockStatus = isOutOfStock
        ? { label: 'Out of Stock', badge: 'badge-danger', icon: <AlertTriangle size={12} /> }
        : product.stock <= 5
            ? { label: `Only ${product.stock} remaining`, badge: 'badge-warning', icon: <Database size={12} /> }
            : { label: `${product.stock} in stock`, badge: 'badge-success', icon: <CheckCircle2 size={12} /> };
                    ...
                    <div className="sticky top-24">
                        ...
                        >
                            {product.image ? (
                                <img
                                    ...
                                    style={{ filter: isOutOfStock ? 'grayscale(0.6)' : 'none' }}
                                />
                            ) : (
                                <div className="w-full h-full flex items-center justify-center">
                                    <Package size={80} style={{ color: 'var(--border-default)' }} />
                                </div>
                            )}
                        ...
                        >
                            {TRUST_ITEMS.map((t, i) => (
                                ...
                                >
                                    <span style={{ color: 'var(--accent-primary)' }}>{t.icon}</span>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, i) => (
                                        <Star key={i} size={15} style={{ color: '#ffb547', fill: '#ffb547' }} />
                                    ))}
                                </div>
                        ...
                        >
                            ...
                            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                                {product.description || 'No description available for this service.'}
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            {currentQty > 0 && (
                                <div
                                    ...
                                    style={{ background: 'var(--accent-subtle)', border: '1px solid rgba(91,91,255,0.15)' }}
                                >
